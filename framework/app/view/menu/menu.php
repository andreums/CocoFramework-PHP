<div id="navigation">
    <ul id="nav" class="sf-menu">
        ...
        <li>
            <a href="./blog.html" class="current"><?php print _("Área de usuario");?></a>
            <ul>
                <li>
                    <a href="/login"><?php print _("Iniciar sesión"); ?></a>
                </li>
                <li>
                    <a href="/usuario/contrasena/recuperar"><?php print _("¿Olvidó su contraseña?"); ?></a>
                </li>
                <li>
                    <a href="/registrarse"><?php print _("Regístro"); ?></a>
                </li> 
            </ul>
        </li>
        <li>
