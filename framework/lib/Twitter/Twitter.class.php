<?php
    ...
    class FW_Twitter extends FW_Twitter_Api {

        public function SESSION($arg) {
            return false;
        }
        ...
        public function __construct() {
            ...
            if ((SESSION("ZanUser") and SESSION("ZanUserMethod") === "twitter") or isset($_GET["oauth_token"])) {
                ...
                print "<h1>Me voy por aquí</h1>";
                parent::__construct("7cNzInKGE4eieuGGC60dA","MpoGPcgyuVjJCfVJQPa6deO8QOzBdTi8LoDaT2s");
            }
        }
        ...
        public function getAccess() {
            $_GET["oauth_token"] = "7cNzInKGE4eieuGGC60dA";
